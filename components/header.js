...
const solutions = [
  ...
  },
  {
    ...
    description: "We customize wordpress theme according to the market needs.",
    href: "#",
    icon: ViewGridIcon,
  },
  {
    name: "Email Templates",
    description: "We are providing Email Template for your marketing compaign.",
    href: "#",
    icon: ViewGridIcon,
  },
                        ...
                        <div className="max-w-7xl mx-auto grid gap-y-6 px-4 py-6 sm:grid-cols-2 sm:gap-8 sm:px-6 sm:py-8 lg:grid-cols-4 lg:px-8 lg:py-12 xl:py-16">
                          {solutions.map((item) => (
                            <a
                              key={item.name}
                              href={item.href}
                              className="-m-3 p-3 flex flex-col justify-between rounded-lg hover:bg-slate-50"
                            >
                          ...
                          <div className="max-w-7xl mx-auto space-y-6 px-4 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-6 lg:px-8">
                            {callsToAction.map((item) => (
                              <div key={item.name} className="flow-root">
                                <a
                                  href={item.href}
                                  className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-slate-900 hover:bg-slate-100"
                                >
                                  <item.icon
                ...
                {({ open }) => (
                  <>
                    <Popover.Button
                      className={classNames(
                        open ? "text-slate-900" : "text-slate-500",
                        "group focus:bg-white rounded-md inline-flex items-center text-base font-medium hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      )}
                    >
                      <span>More</span>
                      <ChevronDownIcon
                    ...
                    >
                      <Popover.Panel className="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg">
                        ...
                        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
                              ...
                              <ul role="list" className="mt-5 space-y-6">
                                {company.map((item) => (
                                  <li key={item.name} className="flow-root">
                                    <a
                                      href={item.href}
                                      className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-slate-900 hover:bg-slate-50"
                                    >
                                      <item.icon
                                        className="flex-shrink-0 h-6 w-6 text-slate-400"
                                        aria-hidden="true"
                          ...
                          <div className="bg-slate-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                            <div>
                              <h3 className="text-sm font-medium tracking-wide text-slate-500 uppercase">
                                From the blog
                              </h3>
                              <ul role="list" className="mt-6 space-y-6">
                                {blogPosts.map((post) => (
                                  <li key={post.id} className="flow-root">
                                    <a
                                      href={post.href}
                                      className="-m-3 p-3 flex rounded-lg hover:bg-slate-100"
                                    >
                  ...
                  <div className="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4">
                    {solutions.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="-m-3 flex items-center p-3 rounded-lg hover:bg-slate-50"
                      >
